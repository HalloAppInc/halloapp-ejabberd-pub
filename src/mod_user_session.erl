...
start(_Host, _Opts) ->
    ...
    gen_iq_handler:add_iq_handler(ejabberd_local, ?PHOTO_SHARING, pb_client_mode, ?MODULE, process_local_iq, 2),
    ok.
...
stop(_Host) ->
    ...
    gen_iq_handler:remove_iq_handler(ejabberd_local, ?PHOTO_SHARING, pb_client_mode),
    ok.
