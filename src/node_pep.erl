...
subscribe_node(Nidx, Sender, Subscriber, AccessModel,
	    SendLast, SendPublishedItems, PresenceSubscription, RosterGroup, Options) ->
    node_flat:subscribe_node(Nidx, Sender, Subscriber, AccessModel, SendLast, SendPublishedItems,
...
publish_item(Nidx, Publisher, Model, MaxItems, ItemId, ItemType, Payload, Now, PubOpts) ->
    node_flat:publish_item(Nidx, Publisher, Model, MaxItems, ItemId, ItemType, Payload, Now, PubOpts).
