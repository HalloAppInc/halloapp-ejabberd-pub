...
publish_item(Nidx, Publisher, Model, MaxItems, ItemId, ItemType, Payload, PubOpts) ->
    node_flat:publish_item(Nidx, Publisher, Model, MaxItems, ItemId, ItemType, Payload, PubOpts).
