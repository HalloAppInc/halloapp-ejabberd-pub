...
lookup_english_string(<<"server.katchup.sms.verification">>) -> <<"Your Katchup verification code">>;
lookup_english_string(<<"server.katchup.voicecall.verification">>) -> <<"Your Katchup verification code is">>;
