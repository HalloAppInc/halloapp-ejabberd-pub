...
-export_type(['pb_auth_request'/0, 'pb_auth_result'/0, 'pb_client_mode'/0, 'pb_client_version'/0]).

-spec encode_msg(#pb_auth_request{} | #pb_auth_result{} | #pb_client_mode{} | #pb_client_version{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 -> encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#pb_auth_request{} | #pb_auth_result{} | #pb_client_mode{} | #pb_client_version{}, atom() | list()) -> binary().
...
get_msg_names() -> [pb_auth_request, pb_auth_result, pb_client_mode, pb_client_version].
...
get_all_source_basenames() -> ["ha_auth.proto", "client_info.proto"].
...
%% functions.
get_all_proto_names() -> ["ha_auth", "client_info"].
