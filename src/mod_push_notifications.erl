...
start(_Host, _Opts) ->
    ...
    ejabberd_hooks:add(push_message_hook, ?PHOTO_SHARING, ?MODULE, push_message_hook, 50),
    ...
    ejabberd_hooks:add(event_push_received, ?PHOTO_SHARING, ?MODULE, event_push_received, 50),
    ok.
...
stop(_Host) ->
    ...
    ejabberd_hooks:delete(event_push_received, ?PHOTO_SHARING, ?MODULE, event_push_received, 50),
    ...
    ejabberd_hooks:delete(push_message_hook, ?PHOTO_SHARING, ?MODULE, push_message_hook, 50),
    ok.
