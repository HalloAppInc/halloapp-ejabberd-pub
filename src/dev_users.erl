...
get_dev_uids() ->
    [
        ...
        %%%%%%%%%%%%%%%%% interns %%%%%%%%%%%%%%%%%%%%
        <<"1000000000872245869">>,  %% Michelle Tang
        <<"1000000000744398024">>,  %% Suraj Pakala
        <<"1000000000955206420">>,  %% Cay Zhang
        <<"1000000000892258892">>,  %% Shenyang Chen
        <<"1000000000816916655">>,  %% Daisy Xu
        <<"1000000000918486785">>,  %% Vaishvi Patel
        <<"1000000000466325264">>,  %% Thomas Neil
        <<"1000000000412496106">>,  %% Luke Arnold
        <<"1000000000518522814">>,  %% Coulson Zhang
        <<"1000000000185238023">>,  %% Vaishvi test
        %%%%%%%%%%%%%%%% contractors %%%%%%%%%%%%%%%%%
