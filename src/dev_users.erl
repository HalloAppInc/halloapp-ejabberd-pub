...
get_dev_uids() ->
    [
        ...
        %%%%%%%%%%%%%%%% interns %%%%%%%%%%%%%%%%
        <<"1000000000281775695">>,  %% Ethan
        <<"1000000000872245869">>,  %% Michelle
        <<"1000000000552016241">>,  %% Graham Jones
        <<"1000000000100073948">>,  %% Graham Android
        <<"1000000000783393490">>,  %% Karen
        <<"1000000000930788274">>,  %% Han
        <<"1000000000964542924">>,  %% Matt
