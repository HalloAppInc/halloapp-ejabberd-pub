...
compute_counts() ->
    ...
    Count1Day = model_active_users:count_active_users_1day(),
    ?INFO_MSG("Number of active users in the past 1 day: ~p", [Count1Day]),
    stat:count("HA/active_users", "1day", Count1Day),
    Count7Days = model_active_users:count_active_users_7day(),
    ?INFO_MSG("Number of active users in the past 7 days: ~p", [Count7Days]),
    stat:count("HA/active_users", "7day", Count7Days),
    Count28Days = model_active_users:count_active_users_28day(),
    ?INFO_MSG("Number of active users in the past 28 days: ~p", [Count28Days]),
    stat:count("HA/active_users", "28day", Count28Days),
    Count30Days = model_active_users:count_active_users_30day(),
    ?INFO_MSG("Number of active users in the past 30 days: ~p", [Count30Days]),
    stat:count("HA/active_users", "30day", Count30Days),
    End = util:now_ms(),
