...
stop_child(Name) ->
    _ = supervisor3:terminate_child(?MODULE, Name),
    _ = supervisor3:delete_child(?MODULE, Name),
    ok.
...
%%%===================================================================
worker(Mod) ->
    {Mod, {Mod, start_link, []}, {permanent, 1}, ?SHUTDOWN_TIMEOUT, worker, [Mod]}.

supervisor(Mod) ->
    supervisor(Mod, Mod).

supervisor(Name, Mod) ->
    {Name, {Mod, start_link, []}, {permanent, 1}, infinity, supervisor, [Mod]}.
