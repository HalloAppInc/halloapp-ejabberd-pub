...
xmpp_to_proto_client_mode_test() ->
    ...
    XmppIq = struct_util:create_iq_stanza(?ID1, undefined, undefined, result, PbClientMode),
...
xmpp_to_proto_client_version_test() ->
    ...
    XmppIq = struct_util:create_iq_stanza(?ID1, undefined, undefined, result, PbClientVersion),
...
proto_to_xmpp_client_version_test() ->
    ...
    XmppIq = struct_util:create_iq_stanza(?ID1, undefined, undefined, get, PbClientVersion),
