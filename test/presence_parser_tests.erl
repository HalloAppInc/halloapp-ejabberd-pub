...
xmpp_to_proto_available_test() ->
    ...
    PbPresence = struct_util:create_pb_presence(?ID1, available, ?UID1_INT, undefined),
...
xmpp_to_proto_away_test() ->
    ...
    PbPresence = struct_util:create_pb_presence(?ID1, away, ?UID1_INT, ?TIMESTAMP1_INT),
...
proto_to_xmpp_available_test() ->
    ...
    PbPresence = struct_util:create_pb_presence(?ID1, available, undefined, undefined),
...
proto_to_xmpp_away_test() ->
    ...
    PbPresence = struct_util:create_pb_presence(?ID1, away, undefined, undefined),
...
proto_to_xmpp_subscribe_test() ->
    ...
    PbPresence = struct_util:create_pb_presence(?ID1, subscribe, ?UID1_INT, undefined),
