...
friend_unfriend_testparallel() ->
    ...
    [
        ...
        ?_assertNot(model_halloapp_friends:is_incoming_friend(Uid2, Uid1)),
        ?_assertNot(model_halloapp_friends:is_outgoing_friend(Uid1, Uid2)),
        ?_assertNot(model_halloapp_friends:is_incoming_friend(Uid1, Uid2)),
        ?_assertNot(model_halloapp_friends:is_outgoing_friend(Uid2, Uid1)),
        %% Uid1 sends a friend request to Uid2
        ?_assertOk(model_halloapp_friends:add_friend_request(Uid1, Uid2)),
        ?_assert(model_halloapp_friends:is_incoming_friend(Uid2, Uid1)),
        ?_assert(model_halloapp_friends:is_outgoing_friend(Uid1, Uid2)),
