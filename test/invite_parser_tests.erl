...
create_pb_invites(InvitesLeft, TimeUnitRefresh, PbInvites) ->
    #pb_invites{
        invites_left = InvitesLeft,
        time_until_refresh = TimeUnitRefresh,
        invites = PbInvites
...
invite_xmpp_to_proto_test() ->
    ...
    PbInvites = create_pb_invites(2, 100, [PbInvite]),
    PbIq = create_pb_iq(?ID1, result, {invites, PbInvites}),
...
invites_xmpp_to_proto_test() ->
    ...
    PbInvites = create_pb_invites(2, 100, []),
    PbIq = create_pb_iq(?ID1, result, {invites, PbInvites}),
...
invite_error_xmpp_to_proto_test() ->
    ...
    PbInvites = create_pb_invites(5, 1000, [PbInvite]),
    PbIq = create_pb_iq(?ID1, result, {invites, PbInvites}),
...
invite_set_proto_to_xmpp_test() ->
    ...
    PbInvites = create_pb_invites(undefined, undefined, [PbInvite1, PbInvite2]),
    PbIq = create_pb_iq(?ID1, set, {invites, PbInvites}),
...
invite_get_proto_to_xmpp_test() ->
    ...
    PbInvites = create_pb_invites(undefined, undefined, []),
    PbIq = create_pb_iq(?ID1, get, {invites, PbInvites}),
