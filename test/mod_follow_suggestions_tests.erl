...
follow_suggestions_test() ->
    ...
    ok = model_accounts:create_account(Uid3, ?PHONE3, ?NAME3, ?USER_AGENT3, ?CAMPAIGN_ID, ?TS1),
    ok = model_accounts:create_account(Uid4, ?PHONE4, ?NAME4, ?USER_AGENT4, ?CAMPAIGN_ID, ?TS2),
